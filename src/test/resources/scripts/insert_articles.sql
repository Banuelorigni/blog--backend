...
VALUES
    ...
    ('article2', 'article test 222', 14, 'https://example.com/cover1.jpg', now(), now(), 'libingbing', 'libingbing', 0, 1),
    ('article3', 'article test 33333', 16, 'https://example.com/cover1.jpg', now(), now(), 'libingbing', 'libingbing', 0, 1);
